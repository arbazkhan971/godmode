...
Evidence: {file:line or codebase pattern — mandatory}
One thing I'd change: {specific suggestion}
```

### 3. Synthesize Consensus

```
Average confidence: {N}/10
Unanimous concerns: {risks raised by 3+ personas}
Disagreements: {where personas diverge, with reasons}
