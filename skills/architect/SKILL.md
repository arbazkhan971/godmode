...
| Performance bottleneck in chosen architecture | Profile first. Check if the bottleneck is in the architecture or implementation. Consider caching, async processing, or read replicas before restructuring. |
