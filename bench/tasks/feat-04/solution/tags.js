...
function atLeast(pairs, minCount) {
  // Keep tags whose count is >= minCount (null = no filtering).
  if (minCount === null) return pairs;
  return pairs.filter((p) => p[1] >= minCount);
}

module.exports = { readStdin, count, rank, atLeast };
