...
3. The full skill catalog (135 skills)
...
If you use an AI coding tool that Godmode does not support yet, adding an adapter makes all 135 skills available on that platform. See [Adding a New Platform Adapter](#adding-a-new-platform-adapter) for the guide.
